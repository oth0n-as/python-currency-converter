...
# Campos para selecionar moedas de origeme desino
# (campos de dlistas) com labels Seleciona a moeda de origem
# Botão de converter
# Lista de Exibição com os nomes das moedas

import customtkinter
from pegar_moedas import nomes_das_moedas, conversoes_disponiveis
...
dict_conversoes_disponiveis = conversoes_disponiveis()
...
campo_moeda_origem = customtkinter.CTkOptionMenu(janela, values=list(dict_conversoes_disponiveis.keys()), # um menu que seleciona uma única opção
                                                 command= carregar_moedas_destino) 
campo_moeda_destino = customtkinter.CTkOptionMenu(janela, values=["Selecione uma moeda de origem"]) # um menu que seleciona uma única opção
...
lista_moedas = customtkinter.CTkScrollableFrame(janela) # uma subjanela "scrollável"

texto_cotacao_moeda = customtkinter.CTkLabel(janela, text="")

moedas_disponiveis = nomes_das_moedas()
